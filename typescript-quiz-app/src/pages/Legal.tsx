      ...
      <div className="flex justify-center items-center space-y-5 mx-4 pb-20">
        <Card className="flex-grow max-w-[1000px]">
          <CardHeader className="justify-center py-6">
            ...
            >
              <Tab key="terms" title="Terms of Service"></Tab>
          ...
          <CardBody className="px-10">
            <div className="space-y-8">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Studucky.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Studucky, accessible from{" "}
                    <a
                      href="https://www.studucky.com/"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://www.studucky.com/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>By email: help@studucky.com</li>
              </ul>
            </div>
          </CardBody>
